...
class HandlerStateRegister:
    def __init__(self) -> None:
        ...
        self.dedicated_layer: dict[States, list[HandlerFactory]] = {}
        self.global_layer: dict[States, list[HandlerFactory]] = {}
    ...
    def register_dedicated(self, state: States, factory: list[HandlerFactory] | HandlerFactory):
    ...
    def register_global(self, state: States, factory: list[HandlerFactory] | HandlerFactory):
    ...
    async def get_dedicated(self, state: States) -> list[HandlerFactory] | None:
        return self.dedicated_layer.get(state)

    async def get_global(self, state: States) -> list[HandlerFactory] | None:
